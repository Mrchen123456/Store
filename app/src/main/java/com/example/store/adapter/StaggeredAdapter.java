...
import com.example.store.widget.RecyclerExtras.OnItemClickListener;
import com.example.store.widget.RecyclerExtras.OnItemLongClickListener;

import java.util.ArrayList;

public class StaggeredAdapter extends RecyclerView.Adapter<ViewHolder>
		implements OnItemClickListener, OnItemLongClickListener {
	private final static String TAG = "StaggeredAdapter";
	private Context mContext;
	private LayoutInflater mInflater;
	private ArrayList<GoodsInfo> mGoodsArray;

	public StaggeredAdapter(Context context, ArrayList<GoodsInfo> goodsArray) {
		mContext = context;
	...
	public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
		...
		v = mInflater.inflate(R.layout.item_staggered, vg, false);
