...
import com.example.store.adapter.CombineAdapter;
import com.example.store.adapter.GridAdapter;
import com.example.store.bean.GoodsInfo;
import com.example.store.util.DisplayUtil;
import com.example.store.util.Utils;
import com.example.store.widget.BannerPager;
import com.example.store.widget.BannerPager.BannerClickListener;
import com.example.store.widget.SpacesItemDecoration;
